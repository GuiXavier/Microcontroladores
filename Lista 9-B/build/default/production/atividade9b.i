...
void formata_contador(unsigned int contador) {
    buffer[0] = (contador / 1000) % 10 + '0';
    buffer[1] = (contador / 100) % 10 + '0';
    buffer[2] = (contador / 10) % 10 + '0';
    buffer[3] = contador % 10 + '0';
    buffer[4] = '\0';
}
