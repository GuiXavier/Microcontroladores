...
FINAL_IMAGE=${DISTDIR}/Lista_1__5_BOT_ES_E_5_LEDs_Piscando.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Lista_1__5_BOT_ES_E_5_LEDs_Piscando.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F877
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Lista_1__5_BOT_ES_E_5_LEDs_Piscando.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Lista_1__5_BOT_ES_E_5_LEDs_Piscando.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F877 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Lista_1__5_BOT_ES_E_5_LEDs_Piscando.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
