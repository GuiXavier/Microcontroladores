...
FINAL_IMAGE=${DISTDIR}/Lista_2__8_LEDs_com_BOTAO_de_inversao.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Lista_2__8_LEDs_com_BOTAO_de_inversao.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F877
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Lista_2__8_LEDs_com_BOTAO_de_inversao.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Lista_2__8_LEDs_com_BOTAO_de_inversao.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F877 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Lista_2__8_LEDs_com_BOTAO_de_inversao.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
